...
app.delete("/tickets/:id", async (req, res) => {
   try {
     ...
     if (result.affectedRows === 0) {
       // If no rows were affected, the ticket doesn't exist
...
// MONGO_URL=mongodb+srv://expense:expense123@cluster0.ouzou.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0
