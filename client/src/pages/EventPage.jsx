  ...
  return (
    <div className="flex flex-col mx-5 xl:mx-32 md:mx-10 mt-5 flex-grow">
     <div >
      ...
      <img src="/eventpage.jpg" alt="" className='rounded object-fill aspect-16:9'/> 
      ...
      <div className="mx-2">
          <h2 className="text-md md:text-xl font-bold mt-3 text-primarydark">{event.ticket_price === 0? 'Free' : 'LKR. '+ event.ticket_price}</h2>
      </div>
      ...
      <div className="mx-2 mt-5">
        ...
        <div className="sm:mx-5 lg-32 mt-6 flex flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              Date: {event.event_date.split("T")[0]} <br />Time: {event.event_time}
              </div>
            </div>
      ...
      <div className="mx-2 mt-5 text-md md:text-xl font-extrabold">
        Share with friends
        <div className="mt-10 flex gap-5 mx-10  ">
